...
/* ── Buttons ── */
export const BTN_PRIMARY   = "h-12 w-full bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl text-base android-press flex items-center justify-center gap-2 disabled:opacity-50 transition-colors";
export const BTN_SECONDARY = "h-12 w-full border-2 border-white/10 text-gray-300 hover:border-blue-500/50 hover:text-blue-300 font-bold rounded-2xl text-base android-press flex items-center justify-center transition-colors";
export const BTN_SM        = "h-9 px-4 text-sm font-bold rounded-xl android-press min-h-0 flex items-center transition-colors";
export const BTN_XS        = "h-8 px-3 text-xs font-bold rounded-xl android-press min-h-0 flex items-center transition-colors";

/* ── Inputs ── */
export const INPUT    = "w-full h-12 px-4 bg-[#1A2236] border border-white/10 rounded-xl text-base text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:bg-[#1E2A44] transition-colors";
export const SELECT   = "w-full h-12 px-3 bg-[#1A2236] border border-white/10 rounded-xl text-base text-white focus:outline-none focus:border-blue-500 transition-colors appearance-none";
export const TEXTAREA = "w-full px-4 py-3 bg-[#1A2236] border border-white/10 rounded-xl text-base text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:bg-[#1E2A44] transition-colors resize-none";
...
export const BADGE_ORANGE = "text-xs font-bold px-2.5 py-1 rounded-full bg-amber-100 text-amber-700";
