...
- Location: e2e/admin/login.spec.ts:18:7
...
Locator: locator('[data-testid=\'admin-sidebar\'], nav, aside').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid=\'admin-sidebar\'], nav, aside').first()
